...
import { Image, AlertTriangle, ArrowUpDown, History, Edit, Lightbulb, Plus, Percent } from 'lucide-react';
...
import { ProductCostMarginIntelligenceDialog } from './ProductCostMarginIntelligenceDialog';
...
export function ProductCard({ 
  ...
  const [costMarginOpen, setCostMarginOpen] = useState(false);
  ...
  return (
    <>
                ...
                <div className="flex items-center gap-1.5">
                  <Button
                    ...
                    onClick={(event) => {
                      ...
                      setCostMarginOpen(true);
                    }}
                  >
                    <Percent className="mr-1 h-3.5 w-3.5" />Custos e margem
                  </Button>
                  <span className={cn(
                    'text-xs',
      ...
      <ProductCostMarginIntelligenceDialog
        productId={costMarginOpen ? product.id : null}
        open={costMarginOpen}
        onOpenChange={setCostMarginOpen}
      />
    </>
  );
}