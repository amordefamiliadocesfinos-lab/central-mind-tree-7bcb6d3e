          ...
          onPreparePostSale={async () => {
            try {
              ...
              const decision = {
                ...
                shouldReply: true,
                reason: analysis?.postSale?.reason ?? authorization.reason,
              };
